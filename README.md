...
- **Primary Dark**: #332D56 (Deep Blue-Purple)
- **Secondary**: #4E6688 (Slate Blue)
- **Accent**: #71C0BB (Teal)
- **Light**: #E3EEB2 (Light Yellow-Green)

### Key Components
1. **Animated Sentiment Gauge**: Semi-circle SVG gauge with rotating needle
2. **Gradient Backgrounds**: Subtle color gradients throughout
3. **Modern Navigation**: Sticky navbar with INSIGHTA branding
4. **Card-based Layouts**: Organized information display
5. **Interactive Charts**: Visual data representation with Chart.js
...
```bash
git clone https://github.com/Sweehar/PS_sample.git
cd PS_sample
```
...
**Terminal 3 - Feedback Pipeline (Optional):**
```bash
...
- Admin Panel: Available after login with admin role
